...
const Carta = ({ saludo, footer, atte }: CartaProps) => {
  ...
  return (
    <section className={`${pacifico.className} p-8 pt-12 bg-[url('../../public/fondo_carta_vertical.webp')] md:bg-[url('../../public/fondo_carta.webp')] bg-no-repeat text-neutral-900 bold font-medium w-full md:w-3/4 md:p-32 text-center text-ms md:text-xl rounded-md`} style={{'backgroundSize': '100% 100%'}}>
